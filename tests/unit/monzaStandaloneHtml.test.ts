...
describe('standalone Monza quality contract', () => {
  ...
  it('uses a fixed-distance chase and a restrained simulator onboard camera', () => {
    expect(html).toContain('const CHASE_DISTANCE = 7.2');
    expect(html).not.toContain('9.5 + speedT * 4.5');
